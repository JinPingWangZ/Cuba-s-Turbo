...
def update_log(tag):
    ...
    with open("C:/Users/Admin/Cuba's Turbo/claim_log",'a') as f:
        f.write("Email: {} Tag: {} \n".format(name, tag))
...
def initiate_turbo(name,accounts,gamertags):
    ...
    try:
            auth_mgr = AuthenticationManager.from_file('C:/Users/Admin/AppData/Local/OpenXbox/xbox/tokens.json')
        ...
        for tag in gamertags:
            ...
            if xbl_client.profile.get_profile_by_gamertag(tag).status_code == 200:
                ...
                if response.status_code == 200:
                    ...
                    os.remove("C:/Users/Admin/AppData/Local/OpenXbox/xbox/tokens.json")
...
print("start")
gamertags = read_file("C:/Users/Admin/Cuba's Turbo/gamertags.txt")
print( "gamertags: ", gamertags )
accounts = read_file("C:/Users/Admin/Cuba's Turbo/accounts.txt")
